...
bool Sphere::Hit(const Ray& ray, RaycastHit& raycastHit, float minDistance, float maxDistance)
{
    float t = 0.0f;
...
bool Sphere::Raycast(const Ray& ray, const glm::vec3& center, float radius, float minDistance, float maxDistance, float& t)
{
